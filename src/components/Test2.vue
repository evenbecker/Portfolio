<template>
  ...
  <div class="widthText">
    ...
    <p>Here are photos of bands I listen to. Many albums of these bands verge on nü-metal and are sometimes straight
      nü-metal. All right reserved to the photographs/labels.</p>
    <div id="w100guitar">
  ...
  <div class="absol">
    <h2>Linkin Park</h2>
    <img alt="Linkin Park" width="850px" height="auto" src="../assets/pictures/LP2002.png">
    <div class="spacer"></div>
    <h2>Evanescence</h2>
